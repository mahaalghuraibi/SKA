...
import StaffProfileAvatar from "../components/shared/StaffProfileAvatar.jsx";
        ...
        {role === "staff" ? (
          <section id="dish-docs" className="grid gap-10 lg:gap-12">
            ...
            <article className={`${glassCard} space-y-5 p-4 sm:p-6`}>
              ...
              {/* ── 1. Search input (first, prominent) ── */}
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      ...
                      type="button"
                      onClick={() => {
                        if (b.id === "all") { resetAllFilters(); return; }
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFilterDateFrom(v);
                      setFilterDateErrors((prev) => ({ ...prev, from: isValidYmdDate(v) ? "" : "صيغة غير صحيحة" }));
                      setQuickPreset(null);
                    }}
                  ...
                  />
                  {filterDateErrors.from ? <p className="text-[11px] text-red-300">{filterDateErrors.from}</p> : null}
                </div>
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const v = e.target.value.trim();
                      setFilterDateTo(v);
                      setFilterDateErrors((prev) => ({ ...prev, to: isValidYmdDate(v) ? "" : "صيغة غير صحيحة" }));
                      setQuickPreset(null);
                    }}
                    className="w-full rounded-xl border border-white/15 bg-[#0B1327]/80 px-3 py-2 text-sm text-slate-100 outline-none focus:border-brand-sky/50"
                  />
                  {filterDateErrors.to ? <p className="text-[11px] text-red-300">{filterDateErrors.to}</p> : null}
                </div>
              </div>
              ...
              {/* ── 6. Secondary filters (collapsible-style row) ── */}
            ...
            {toast ? (
              <div
                className={`pointer-events-none fixed start-3 end-3 top-20 z-[200] rounded-xl border px-3 py-3 text-sm font-medium shadow-xl backdrop-blur-md sm:start-4 sm:end-auto sm:top-24 sm:max-w-sm ${
                  toast.type === "success"
              ...
              >
                ...
                >
                  ...
                  <div className="mt-6 flex flex-wrap justify-end gap-2">
                    ...
                    >
                      {deleteLoading ? <Spinner className="h-4 w-4 border-2 border-red-200/30 border-t-red-100" /> : null}
                      حذف نهائي
                    </button>
                  </div>
                </div>
